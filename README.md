...
>## OUTPUT FILE
>   The output file generated by the program contains the data that represent the maze, the entry and the exit
> coordonates of the maze, and the shortest solution path from start to exit at the end. This file is formatted as
> required by the subject and is mean to be used to recreate map for other project. 
>
>    **output file format:**
>    ```
>       91393D1117
...
>    ```
>
>   First block of data is the hexadecimal value of each Cell, the value symbolize the open wall of the cells
>   described by the subject.
>
>   The next to line of data are the entry and exit coordonate
>
>   The last line is the solution path instruction, each instruction is the direction to take:
>
>   -   N: North
>   -   S: South
>   -   E: East
